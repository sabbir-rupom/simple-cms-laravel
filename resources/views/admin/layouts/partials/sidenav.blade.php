<aside
  class="sidebar -translate-x-full md:translate-x-0"
    ...
    <ul class="space-y-2">
      ...
      <li class="nav-item">
        <button type="button" class="group"
          ...
          <span class="parent-menu">Pages</span>
          <i class="far fa-chevron-down" class="w-6 h-6"></i>
        </button>
        <ul id="dropdown-pages" class="menu-dropdown hidden">
          <li>
            <a href="#"
              class="group">Settings</a>
          </li>
          <li>
            <a href="#"
              class="group">Kanban</a>
          </li>
          <li>
            <a href="#"
              class="group">Calendar</a>
          </li>
        </ul>
      </li>
      <li>
